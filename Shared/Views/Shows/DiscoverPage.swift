...
struct DiscoverPage: View {
    ...
    var displayedShows : [Show] {
        if (searchText != "") {
            ...
            return applyAllFilters(serviceFilters: appliedServiceFilters, statusFilters: appliedStatusFilters, tagFilters: [], showLengthFilter: selectedLength, shows: undiscoveredShows, selectedLimited: 0)
        }
    }
